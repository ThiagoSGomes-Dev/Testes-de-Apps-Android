...
|------|-----------|-----------------|-------------------|------|
| **JUnit** | Framework base para testes unitários. | Para testar lógica de negócio sem dependência do Android SDK. | [code](https://github.com/ThiagoSGomes-Dev/Testes-de-Apps-Android/edit/main/README.md#junit)  | junit.org |
